...
![CANARY architecture flow from regional supplier pages through Bright Data, validation, Neon, risk intelligence, and same-Collector-ID recovery](public/assets/canary-system-flow.svg)
